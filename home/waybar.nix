    ...
    settings = [
      {
        ...
        "custom/brightness" = {
          ...
          on-scroll-up = "flock -n /tmp/ddcutil-brightness.lock ddcutil setvcp 10 + 25 --noverify";
          on-scroll-down = "flock -n /tmp/ddcutil-brightness.lock ddcutil setvcp 10 - 25 --noverify";
          tooltip = false;
        };
